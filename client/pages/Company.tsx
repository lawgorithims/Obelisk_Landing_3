        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-2 gap-6 items-start">
          <div>
            ...
            <div className="space-y-6 text-lg leading-relaxed text-gray-800">
              <p>
                Obelisk was founded by{" "}
                <span className="font-semibold">Benjamin Suslavich</span>, an
                attorney and engineer, and{" "}
                <span className="font-semibold">Schuyler Gleaves</span>, a
                former Microsoft software engineer.
              </p>
              <p>
                We created Obelisk with a clear mission: to eliminate the
                tedious, time-consuming tasks that slow attorneys down, so they
                can focus on what truly matters — strategy, advocacy, and
                serving their clients.
              </p>
              <p>
                Too often, legal technology adds complexity instead of solving
                real problems. By combining Benjamin’s legal experience with
                Schuyler’s engineering expertise, we built a platform that
                actually works for lawyers. Obelisk verifies work against
                authoritative sources, streamlines drafting, and reduces the
                risk of error.
              </p>
              <p>
                Our vision is simple: empower attorneys with tools that save
                time, ensure accuracy, and let them dedicate their energy to the
                practice of law.
              </p>
            </div>
          ...
          <div className="w-full md:justify-self-end">
            <div className="bg-transparent border-0 rounded-none shadow-none p-0 overflow-hidden flex items-center justify-center -mt-24 md:-mt-40 lg:-mt-48">
              <div
                ref={lottieRef}
                className="w-full h-[700px] sm:h-[880px] md:h-[1100px]"
                aria-label="Obelisk loading animation"
              />
            </div>
          </div>
        </div>
