            ...
            <div className="flex items-center space-x-3">
              <div className="w-10 h-10 bg-[#E0E0E0] rounded-lg flex items-center justify-center">
                <svg width="20" height="20" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M20 0L0 15V20H2.5V37.5H10V25H17.5V37.5H37.5V20H40V15L35 11.25V2.5H27.5V5.625L20 0ZM22.5 25H30V32.5H22.5V25Z" fill="#2196F3"/>
                </svg>
              </div>
              <span className="text-[#E0E0E0] text-lg font-normal">Obelisk</span>
              <Button variant="ghost" size="sm" className="ml-auto p-1 h-5 w-5 text-[#A0A0A0] hover:text-white">
          ...
          <div className="p-4 border-t border-[#3F4350]/30 space-y-4">
            ...
            <div className="flex items-center space-x-3 pt-2">
              ...
              <div>
                ...
                <div className="text-[#A0A0A0] text-xs">schuylergleaves@outlook.com</div>
              </div>
            </div>
          </div>
        </aside>
